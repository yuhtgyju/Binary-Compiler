ascii_to_bin_dict = {
    "\n": "00001010", " ": "00100000", "!": "00100001", "\"": "00100010", "#": "00100011", "$": "00100100",
    "%": "00100101", "&": "00100110", "\'": "00100111", "(": "00101000", ")": "00101001", "*": "00101010",
    "+": "00101011", ",": "00101100", "-": "00101101", ".": "00101110", "/": "00101111", "0": "00110000",
    "1": "00110001", "2": "00110010", "3": "00110011", "4": "00110100", "5": "00110101", "6": "00110110",
    "7": "00110111", "8": "00111000", "9": "00111001", ":": "00111010", ";": "00111011", "<": "00111100",
    "=": "00111101", ">": "00111110", "?": "00111111", "@": "01000000", "A": "01000001", "B": "01000010",
    ...
    "y": "01111001", "z": "01111010", "{": "01111011", "|": "01111100", "}": "01111101", "~": "01111110"
}
...
with open(input_File, "r") as file:
    inputfile_list = file.read().strip()  # Remove leading/trailing whitespace
    file.close()
...
# Map each character to its binary representation and join the results
binary_output = ''.join(ascii_to_bin_dict.get(char, "Error") for char in inputfile_list)

# Write to binary file
with open("temp.bin", "w") as file:
